...
class Vendor extends CI_Controller
{
    ...
    function product($para1 = '', $para2 = '', $para3 = '')
    {
        ...
        if ($para1 == 'do_add') {
			...
			$data['exclusions']        = $this->input->post('exclusions');
			$data['city']        = $this->input->post('city');
			$data['additional_information']        = $this->input->post('additional_information');
			$data['your_tickets']        = $this->input->post('your_tickets');
			...
			$package1['name']  			= json_encode($this->input->post('ad_package_names'));
            $package1['sale_price']     = json_encode($this->input->post('sale_price1'));
			$package1['purchase_price'] = json_encode($this->input->post('purchase_price1'));
            $package1['Discount1'] 			= json_encode($this->input->post('Discount1'));
            $data['package1']			= json_encode($package1);
			$time['name']  				= json_encode($this->input->post('time'));
            $time['value'] 				= json_encode($this->input->post('time'));
