                ...
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        <div id="business_details" class="tab-pane fade">
							...
							<div class="col-sm-6">
                            <div id="more_price" class="btn btn-mint btn-labeled fa fa-plus pull-right">
                            Add More Price</div>
                            </div>
                            </div>-->
                            ...
                            <div class="form-group btm_border">
                               <!-- <label class="col-sm-4 control-label" for="demo-hor-inputpass"></label>-->
                                <div class="col-sm-6">
                                    ...
                                    <div id="more_pr" class="btn btn-mint btn-labeled fa fa-plus pull-right">
                                    Add More Packages</div>
                                </div>
                            </div>
                        ...
                        <div id="product_details" class="tab-pane fade active in">
							...
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">City</label>
                                <div class="col-sm-6">
                                    <input type="text" name="city" id="demo-hor-5" placeholder="City" class="form-control unit required">
                                </div>
                            </div>
                           ...
                           <!-- <div class="form-group btm_border">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-12">Main Image</label>
                                <div class="col-sm-6">
							 ...
							 <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-12">Image</label>
                                <div class="col-sm-6">
                                <span class="pull-left btn btn-default btn-file"> <?php echo translate('choose_file');?>
                                    <input type="file" multiple name="images[]" onchange="preview1(this);" id="demo-hor-12" class="form-control required">
                                    </span>
                                    <br><br>
							 ...
							 <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                <span class="pull-left btn btn-default btn-file"> <?php echo translate('choose_file');?>
                                    <input type="file" multiple name="images[]" onchange="preview2(this);" id="demo-hor-12" class="form-control required">
                                    </span>
                                    <br><br>
							 ...
							 <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                <span class="pull-left btn btn-default btn-file"> <?php echo translate('choose_file');?>
                                    <input type="file" multiple name="images[]" onchange="preview3(this);" id="demo-hor-12" class="form-control required">
                                    </span>
                                    <br><br>
							...
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Where</label>
                                <div class="col-sm-6">
                                    <input type="text" name="location" id="demo-hor-5" placeholder="Goa" class="form-control unit required">
                                </div>
                            </div>
							
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Duration</label>
                                <div class="col-sm-6">
                                    <input type="text" name="duration" id="demo-hor-5" placeholder="2" class="form-control unit required">
                                </div>
							...
							<option value="0">12 AM</option>
							   ...
							   <div id="more_time"></div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-inputpass"></label>
                                <div class="col-sm-6">
                                    <div id="more_tm" class="btn btn-mint btn-labeled fa fa-plus pull-right">
                                    Add More Time</div>
                                </div>
                            </div>
						<div class="form-group">
                         <label class="col-sm-4 control-label" for="demo-hor-5">Day</label>
						<select  name= "days" multiple="multiple" id="langOpt31">
                        ...
                        <div class="form-group btm_border">
							...
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Highlights</label>
                                <div class="col-sm-6">
                                    <textarea rows="9"  class="summernotes" data-height="200" data-name="highlights"></textarea>
                                </div>
                            </div>
							
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Inclusions</label>
                                <div class="col-sm-6">
                                    <textarea rows="9"  class="summernotes" data-height="200" data-name="inclusions"></textarea>
                                </div>
                            </div>
							
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Exclusions</label>
                                <div class="col-sm-6">
                                    <textarea rows="9"  class="summernotes" data-height="200" data-name="exclusions"></textarea>
                                </div>
                            </div>
							
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Additional Informations</label>
                                <div class="col-sm-6">
                                    <textarea rows="9"  class="summernotes" data-height="200" data-name="additional_information"></textarea>
                                </div>
                            </div>
							
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Your Tickets</label>
                                <div class="col-sm-6">
                                    <textarea rows="9"  class="summernotes" data-height="200" data-name="your_tickets"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    window.preview = function (input) {
        ...
        if (input.files && input.files[0]) {
            ...
            $(input.files).each(function () {
                ...
                reader.readAsDataURL(this);
                reader.onload = function (e) {
                    $("#previewImg4").append("<div style='float:left;border:4px solid #303641;padding:5px;margin:5px;'><img height='80' src='" + e.target.result + "'></div>");
                }
            });
        }
    }
...
$( document ).ready(function() {
    ...
    $("#more_tm").click(function(){
        $("#more_time").append(''
            +'<div class="form-group">'
            +'<label class="col-sm-4 control-label" for="demo-hor-5">Time</label>'
            +'<select  id = "ab[]" name="time[]" >'
			+'<option value="7">7 AM</option>'
			+'<option value="8">8 AM</option>'
            +'<option value="9">9 AM</option>'
            +'<option value="10">10 AM</option>'
	  ...
	  $("#more_pr").click(function(){
        $("#more_price").append(''
			+'<br>'
            +'<div>'
            +'    <div>'
            +'        <input type="text" name="ad_package_names[]" class="form-control"  placeholder="Package Name">'
            +'    </div>'
			+'<br>'
            +'<div>'
            +'<input type="number" name="sale_price1[]" id="demo-hor-6"  placeholder="<?php echo translate('sale_price');?>" class="form-control required">'
            +            '</div>'
			+'<br>'
			+'<div>'
			...
			+'<br>'
			+'<div>'
            +'<input type="number" name="Discount1[]" id="demo-hor-6"  placeholder="Discount" class="form-control required">'
            +            '</div>'
			+'<br>'
            +'    <div class="col-sm-2">'
            +'        <span class="remove_it_v rms btn btn-danger btn-icon btn-circle icon-lg fa fa-times" onclick="delete_row(this)"></span>'
