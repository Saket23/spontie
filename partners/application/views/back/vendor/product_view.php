        ...
        <div class="text-center pad-all">
            ...
            <div class="col-md-9">   
                <table class="table table-striped" style="border-radius:3px;">
                    ...
                    <tr>
                        <th class="custom_td">Highlights</th>
                        <td class="custom_td"><?php echo $row['highlights']; ?></td>
                    </tr>
					  <tr>
                        <th class="custom_td">Exclusions</th>
                        <td class="custom_td"><?php echo $row['exclusions']; ?></td>
                    </tr>
					  <tr>
                        <th class="custom_td">Inclusions</th>
                        <td class="custom_td"><?php echo $row['inclusions']; ?></td>
                    </tr>
					  <tr>
                        <th class="custom_td">Additional Information</th>
                        <td class="custom_td"><?php echo $row['additional_information']; ?></td>
                    </tr>
					  <tr>
                        <th class="custom_td">Your  Tickets</th>
                        <td class="custom_td"><?php echo $row['your_tickets']; ?></td>
                    </tr>
					  <tr>
