                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
							...
							<div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="city" id="demo-hor-5" value="<?php echo $row['city']; ?>" placeholder="City" class="form-control unit required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
							...
							<div class="form-group btm_border">
							  ...
							  <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9" class="summernotes" data-height="200" data-name="highlights">
                                        <?php echo $row['highlights']; ?></textarea>
                                </div>
                            </div>
							  ...
							  <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9" class="summernotes" data-height="200" data-name="inclusions">
                                        <?php echo $row['inclusions']; ?></textarea>
                                </div>
                            </div>
							  ...
							  <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9" class="summernotes" data-height="200" data-name="exclusions">
                                        <?php echo $row['exclusions']; ?></textarea>
                                </div>
                            </div>
							  ...
							  <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9" class="summernotes" data-height="200" data-name="additional_information">
                                        <?php echo $row['additional_information']; ?></textarea>
                                </div>
                            </div>
							  ...
							  <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9" class="summernotes" data-height="200" data-name="your_tickets">
                                        <?php echo $row['your_tickets']; ?></textarea>
                                </div>
                            </div>
							<!--<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-14">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9"  name="highlights"  placeholder="Highlight for your Product" class="form-control"><//?php echo $row['highlights'];?></textarea>
                                </div>
                            </div>
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-14">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9"  name="inclusions" id="demo-hor-5" placeholder="Highlight for your Product" class="form-control"><//?php echo $row['inclusions']; ?></textarea>
                                </div>
                            </div>
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-14">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9"  name="exclusions" id="demo-hor-5" placeholder="Highlight for your Product" class="form-control"><//?php echo $row['exclusions']; ?></textarea>
                                </div>
                            </div>
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-14">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9"  name="additional_information" id="demo-hor-5" placeholder="Highlight for your Product" class="form-control"><//?php echo $row['additional_information']; ?></textarea>
                                </div>
                            </div>
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-14">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9"  name="your_tickets" id="demo-hor-5" placeholder="Highlight for your Product" class="form-control"><//?php echo $row['your_tickets']; ?></textarea>
                                </div>
                            </div>-->
                            <?php
