	...
	<div class="footer-<?php echo $theme_color; ?>">
            ...
            <div class="copyright">
                <div class="container">
                	<div class="row">
                    	<div class="col-md-7"> 
                        	<p class="pull-left list-unstyled link-list">2015 &copy; <?php echo translate('all_rights_reserved'); ?> @ <a target="_blank" href="<?php echo base_url(); ?>">Spontieapp</a> | <a target="_blank" href="<?php echo base_url(); ?>index.php/home/legal/terms_conditions"><?php echo translate('terms_&_condition'); ?></a> | <a target="_blank" href="<?php echo base_url(); ?>index.php/home/legal/privacy_policy"><?php echo translate('privacy_policy'); ?></a></p>
                        </div>
                    	<div class="col-md-5"> 
