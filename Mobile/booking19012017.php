...
<?php
require 'dbconnect.php';
$sql= mysql_query("select 10-sum(no_of_adult) as count1,time from booking where date=DATE_FORMAT(NOW(), '%m/%d/%Y') and product_id='".$_GET['id']."'group by time" )or die(mysql_error());
