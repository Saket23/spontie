...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
   <meta name="Keywords" content="Spontieapp,Spontie,Last Minute Ticket Booking,Discover,Activities,Tours,Events Adventures,Experience,City,Demand,Goa,Cheap">
   ...
   <div class="page-content" id="main-stack">
      <div class="w-nav navbar" data-collapse="all" data-animation="over-left" data-duration="400" data-contain="1" data-easing="ease-out-quint" data-no-scroll="1">
        <div class="w-container">
          ...
          <div class="navbar-title">Pick Your City</div>
          ...
          <!--<a class="w-inline-block navbar-button" href="groups.html" data-load="1">
...
<section style="padding-top: 70px;">
            <!--<a class="w-inline-block" href="Goa.php" data-load="1">-->
			<?php echo'<a class="w-inline-block" href="product.php?city=Goa" data-load="1">';?>
              <div class="image-new"><h2><div class="text">GOA</div></h2></div>
              <!--<div>
                <h2 class="title-new">Apple products unleashed</h2>
                <p class="description-new">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolistique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam erat....</p><a class="category-link" href="#">PRODUCTIVITY</a><a class="category-link" href="#">BUSINESS</a>
              </div>-->
            </a>
			</section>
  <section>
            <!--<a class="w-inline-block" href="newitem.html" data-load="1">-->
			<?php echo'<a class="w-inline-block" href="product.php?city=Bali" data-load="1">';?>
              <div class="image-new bg2"><h2><div class="text">BALI</div></h2></div>
              <!--<div class="text-new">
