	...
	if($tim=='0')
	{
		return '12 AM';
			  ...
			  <h2 class="title-new">Your Ticket</h2>
               <p class="description-new">Your tickets will be emailed to you within 20 minutes of your purchase. You must carry a printed copy of the tickets to the venuealong with valid photo ID. </p>
			  ...
			  <br>
			  <div class="w-widget w-widget-map hero-map" data-widget-latlng="12,77" data-widget-style="roadmap" data-widget-zoom="12" data-widget-tooltip="We are here!"></div>
			              </div>
