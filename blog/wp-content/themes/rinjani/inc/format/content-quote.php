<article  id="post-<?php the_ID(); ?>" <?php post_class( 'post'); ?>>
	...
	<div class="post-content row">
	    ...
	    $author_image   = get_field('author_image');  ?>
			...
			<blockquote>
	            <?php the_content(); ?>
	            <h5 class="quote-author"><?php echo sanitize_text_field( $quote_author ); ?></h5>
	            <cite><em><?php echo sanitize_text_field( $author_job ); ?></em></cite>
			...
			<div class="meta-bottom">
				<span><?php esc_html_e( 'Categories: ', 'rinjani' ); ?><em><?php the_category(', '); ?></em></span>
				<span><?php esc_html_e( 'Tags: ', 'rinjani' ); ?><em><?php the_tags('',', ',''); ?></em></span>
			</div>
